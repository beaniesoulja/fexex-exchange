  ...
  return (
    <section className="fexex-pop-in mb-8 space-y-5" aria-labelledby="operations-heading">
      <div className="rounded-3xl border border-[#f4f3ee]/10 bg-[#202323] p-5 sm:p-6">
        <p className="text-xs font-semibold tracking-wide text-[#bfe3ff]">USERS & SAFEGUARDS</p>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        {[
          ...
          ["System manager", "Current admin role: review trades, set card and crypto rates, and manage the customer catalog.", "#bfe3ff"],
